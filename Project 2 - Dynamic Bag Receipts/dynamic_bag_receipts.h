...
#ifndef DYNAMIC_BAG_RECEIPTS_H
#define DYNAMIC_BAG_RECEIPTS_H
...
class bag{ 
    public:
        ...
        bag(size_type initial_capacity = CAPACITY);
        ...
        size_type count(const value_type& target) const;
    private:
        value_type *data;   // Pointer for the partially filled dymanic array
		int *receipt;
